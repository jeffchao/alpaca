...
describe 'Rack::Alpaca' do
  ...
  describe 'Whitelist' do
    ...
    it 'should have a whitelist' do
      _(Rack::Alpaca.whitelist.class).must_equal Hash
      Rack::Alpaca.whitelist.each { |ip, v| _(ip.class).must_equal IPAddr }
      _(Rack::Alpaca.whitelist.keys).must_equal @ips
    end
  ...
  describe 'Blacklist' do
    ...
    it 'should have a blacklist' do
      _(Rack::Alpaca.blacklist.class).must_equal Hash
      Rack::Alpaca.whitelist.each { |ip, v| _(ip.class).must_equal IPAddr }
      _(Rack::Alpaca.blacklist.keys).must_equal @ips
    end
